(function(e) {
    ...
    t.o = function() {
        ...
        this.run = function() {
            ...
            var maximo_alcance = 1000;
            var max_tam = this.$.attr("max-tam");
            var inp_color = this.$.data("inputcolor");
            var ray_color = this.$.data("fgcolor") || "#373b40";
            if(max_tam != null){
                maximo_alcance = max_tam;
            }
            var cpu_meter = this.$.attr("cpu-meter");
            if(cpu_meter != null){
                inp_color = "#fff";
                ray_color = "#30b2a1";
            }
            
            var inf_chart = this.$.attr("inf-chart");
            if(inf_chart != null){
                inp_color = "#5f5755";
            }
            
            var i_color = this.$.attr("inp-color");
            if(i_color != null){
                inp_color = i_color;
            }
            ...
            this.o = e.extend({
                ...
                max: this.$.data("max") !== undefined ? this.$.data("max") : maximo_alcance,
                stopper: true,
        ...
        this._carve = function() {
            if (this.relative) {
                var e = this.relativeWidth ? this.$div.parent().width() * parseInt(this.o.width) / 1000 : this.$div.parent().width(),
                    t = this.relativeHeight ? this.$div.parent().height() * parseInt(this.o.height) / 1000 : this.$div.parent().height();
    ...
    t.Dial = function() {
        ...
        this.extend = function() {
            ...
            var backColor = this.$.data("bgcolor") || "#EEEEEE";
            /*var cpu_meter = this.$.attr("cpu-meter");
            if(cpu_meter != null){
                backColor = "rgba(55, 59, 64, 0.274)";
            }
            var i_color = this.$.attr("inp-color");
            if(i_color != null){
                backColor = "rgba(55, 59, 64, 0.274)";
        ...
        this.init = function() {
            ...
            this.$.val(this.v);
            this.w2 = this.w / 2;
            this.cursorExt = this.o.cursor / 1000;
